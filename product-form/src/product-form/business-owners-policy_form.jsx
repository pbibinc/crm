...
const storedBusinessOwnersPolicyData = () => {
    const businessOwnersPolicyData = JSON.parse(sessionStorage.getItem("BusinessOwnersPolicyData"));
...
const [propertyAddress, setPropertyAddress] = useState(() => storedBusinessOwnersPolicyData().propertyAddress || "");
const [lossPayeeInformation, setLossPayeeInformation] = useState(() => storedBusinessOwnersPolicyData().lossPayeeInformation || "");
const [buildingIndustry, setBuildingIndustry] = useState(() => storedBusinessOwnersPolicyData().buildingIndustry ||"");
const [occupancy, setOccupancy] = useState(() => storedBusinessOwnersPolicyData().occupancy || {});
const [costOfBuilding, setCostOfBuilding] = useState(() => storedBusinessOwnersPolicyData().costOfBuilding || "");
const [buildingPropertyLimit, setBuildingPropertyLimit] = useState(() => storedBusinessOwnersPolicyData().buildingPropertyLimit || "");
const [buildingConstructionType, setBuildingConstructionType] = useState(() => storedBusinessOwnersPolicyData().buildingConstructionType || {});
const [yearBuilt, setYearBuilt] = useState(() => storedBusinessOwnersPolicyData().yearBuilt || "");
const [squareFootage, setSquareFootage] = useState(() => storedBusinessOwnersPolicyData().squareFootage || "");
const [numberOfFloors, setNumberOfFloors] = useState(() => storedBusinessOwnersPolicyData().numberOfFloors || "");
const [automaticSprinklerSystem, setAutomaticSprinklerSystem] = useState(() => storedBusinessOwnersPolicyData().automaticSprinklerSystem || "");
const [automaticFireAlarm, setAutomaticFireAlarm] = useState(() => storedBusinessOwnersPolicyData().automaticFireAlarm || "");
const [distanceToNearestFireHydrant, setDistanceToNearestFireHydrant] = useState(() => storedBusinessOwnersPolicyData().distanceToNearestFireHydrant || "");
const [distanceToNearestFireStation, setDistanceToNearestFireStation] = useState(() => storedBusinessOwnersPolicyData().distanceToNearestFireStation || "");
const [automaticCommercialCookingExtinguishingSystem, setAutomaticCommercialCookingExtinguishingSystem] = useState(() => storedBusinessOwnersPolicyData().automaticCommercialCookingExtinguishingSystem || {});
const [automaticBurglarAlarm, setAutomaticBurglarAlarm] = useState(() => storedBusinessOwnersPolicyData().automaticBurglarAlarm || {});
const [securityCamera, setSecurityCamera] = useState(() => storedBusinessOwnersPolicyData().securityCamera || {});
const [lastUpdateRoofingYear, setLastUpdateRoofingYear] = useState(() => storedBusinessOwnersPolicyData().lastUpdateRoofingYear || "");
const [lastUpdateHeatingYear, setLastUpdateHeatingYear] = useState(() => storedBusinessOwnersPolicyData().lastUpdateHeatingYear || "");
const [lastUpdatePlumbingYear, setLastUpdatePlumbingYear] = useState(() => storedBusinessOwnersPolicyData().lastUpdatePlumbingYear || "");
const [lastUpdateElectricalYear, setLastUpdateElectricalYear] = useState(() => storedBusinessOwnersPolicyData().lastUpdateElectricalYear || "");
const [expirationOfIM, setExpirationOfIM] = useState(() => storedBusinessOwnersPolicyData().expirationOfIM ? new Date(storedBusinessOwnersPolicyData().expirationOfIM) : new Date());
const [priorCarrier, setPriorCarrier] = useState(() => storedBusinessOwnersPolicyData().priorCarrier || "");
const [amountOfBusinessOwnersPolicy, setAmountOfBusinessOwnersPolicy] = useState(() => storedBusinessOwnersPolicyData().amountOfBusinessOwnersPolicy || "");

const [dateOfLoss, setDateOfLoss] = useState(() => storedBusinessOwnersPolicyData().dateOfLoss ? new Date(storedBusinessOwnersPolicyData().dateOfLoss) : new Date());
const [lossAmount, setLossAmount] = useState(() => storedBusinessOwnersPolicyData().lossAmount || "");

const [isEditing, setIsEditing] = useState(() => storedBusinessOwnersPolicyData().isUpdate == true ? false : true);
const [isUpdate, setIsUpdate] = useState(() => storedBusinessOwnersPolicyData().isUpdate || false);


 // setting for building industry option
 const buildingIndustryOptions = [
    {value: "Apartment and Condo Assoc", label: "Apartment and Condo Assoc"},
    {value: "Auto Repair/Service and Car Washes", label: "Auto Repair/Service and Car Washes"},
    {value: "Contractor and Landscaper", label: "Contractor and Landscaper"},
  ...
  //setting for construction type option
   const constructionTypeOptions = [
    ...
    const [isHaveLossChecked, setIsHaveLossChecked] = useState(() => storedBusinessOwnersPolicyData().isHaveLossChecked || false);
    const [haveLossDateOption, setHaveLossDateOption] = useState(() => storedBusinessOwnersPolicyData().haveLossDateOption || {value: 1, label: "MM/DD/YYYY"});
    ...
    useEffect(() => {
        ...
        sessionStorage.setItem("BusinessOwnersPolicyData", JSON.stringify(BusinessOwnersPolicyData));
    },[propertyAddress,
        lossPayeeInformation,
        buildingIndustry,
        occupancy,
                ...
                <Column
                  ...
                  colContent={
                    <>
                       ...
                       <Form.Control
                           type="text"
                           onChange={(e) => setLossPayeeInformation(e.target.value)}
                           disabled={!isEditing}
                  ...
                  colContent={
                    <>
                       ...
                       <Select
                          ...
                          onChange={(selectedOption) => setBuildingIndustry({value:selectedOption.value, label:selectedOption.label})}
                  ...
                  colContent={
                    <>
                       ...
                       <Select
                            ...
                            classNamePrefix="select"
                            options={buildingIndustryOptions}
                            onChange={(selectedOption) => setOccupancy({value:selectedOption.value, label:selectedOption.label})}
                            isDisabled={!isEditing}
                            value={occupancy}
                        />
                    </>
                  ...
                  colContent={
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => setCostOfBuilding(e.target.value)}
                           disabled={!isEditing}
                  ...
                  colContent={
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => setBuildingPropertyLimit(e.target.value)}
                           disabled={!isEditing}
                    ...
                    <>
                       <Label labelContent="Building Construction Type"/>
                        <Select
                             ...
                             onChange={(selectedOption) => setBuildingConstructionType({value:selectedOption.value, label:selectedOption.label})}
                             isDisabled={!isEditing}
              ...
              colContent={
                <>
                  ...
                  <Select
                    ...
                    onChange={(selectedOption) => setAutomaticCommercialCookingExtinguishingSystem({value:selectedOption.value, label:selectedOption.label})}
                    isDisabled={!isEditing}
                ...
                <>
                  ...
                  <Select
                    ...
                    options={[
                        ...
                        {value: "Central or Police Station", label: "Central or Police Station"},
                        {value: "Outside Siren Only", label: "Outside Siren Only"},
                    ]}
                    onChange={(selectedOption) => setAutomaticBurglarAlarm({value:selectedOption.value, label:selectedOption.label})}
                    isDisabled={!isEditing}
            ...
            colContent={
              <>
                ...
                <Select
                  ...
                  onChange={(selectedOption) => setSecurityCamera({value:selectedOption.value, label:selectedOption.label})}
                  isDisabled={!isEditing}
                  ...
                  colContent={
                    <>
                       ...
                       <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => setLastUpdateRoofingYear(e.target.value)}
                            disabled={!isEditing}
                  ...
                  colContent={
                    <>
                        ...
                        <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => setLastUpdateHeatingYear(e.target.value)}
                            disabled={!isEditing}
                  ...
                  colContent={
                    <>
                       ...
                       <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => setLastUpdatePlumbingYear(e.target.value)}
                            disabled={!isEditing}
                  ...
                  colContent={
                    <>
                        ...
                        <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => setLastUpdateElectricalYear(e.target.value)}
                            disabled={!isEditing}
                  ...
                  colContent={
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                            onChange={(e) => setAmountOfBusinessOwnersPolicy(e.target.value)}
                            disabled={!isEditing}
                                  ...
                                  <Row
                                      rowContent={
                                          <DatePicker
                                              ...
                                              showYearDropdown
                                              className="form-control form-date-picker"
                                              onChange={(date) => setDateOfLoss(date)}
                                              disabled={!isEditing}
                                          />
                                      }
                                  />
