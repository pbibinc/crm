...
const ToolsEquipmentForm = () => {
    ...
    const [isEditing, setIsEditing] = useState(() => storedToolsEquipment()?.isUpdate == true ? false : true);
    const [isUpdate, setIsUpdate] = useState(() => storedToolsEquipment()?.isUpdate || false);

    //setting of most value
    const[miscellaneousTools, setMiscellaneousTools] = useState(() => storedToolsEquipment()?.miscellaneousTools || "");
    const[rentedLeasedEquipment, setRentedLeasedEquipment] = useState(() => storedToolsEquipment()?.rentedLeasedEquipment || "");
    const[scheduledEquipment, setScheduledEquipment] = useState(() => storedToolsEquipment()?.scheduledEquipment || "");

    //setting for select equipment type
    const [typeOfEquipment, setTypeOfEquipment] = useState(() => storedToolsEquipment()?.typeOfEquipment || {});
    const [fixedTypeOfEquipment, setFixedTypeOfEquipment] = useState(() => storedToolsEquipment()?.fixedTypeOfEquipment || {});
    const equipmentType = [
    ...
    const [equipmentInformation, setEquipmentInformation] = useState(() => storedToolsEquipment()?.equipmentInformation || [{}]);
    const [firstEquipmentInformation, setFirstEquipmentInformation] = useState(() => storedToolsEquipment()?.firstEquipmentInformation || [{}]);
    const allEquipmentInformation = [firstEquipmentInformation, ...equipmentInformation];
    ...
    const handleRemoveEquipment = (indexToRemove) => {
        setEquipmentInformation(equipmentInformation.filter((_, index) => index !== indexToRemove));
    };
    ...
    const [deductibleAmount, setDeductibleAmount] = useState(() => storedToolsEquipment()?.deductibleAmount || {});
    ...
    const [expirationOfIM, setExpirationOfIM] = useState(() => storedToolsEquipment()?.expirationOfIM ? new Date(storedToolsEquipment()?.expirationOfIM) : new Date());
    const [priorCarrier, setPriorCarrier] = useState(() => storedToolsEquipment()?.priorCarrier || "");

    //setting for have loss click switch
    const [isHaveLossChecked, setIsHaveLossChecked] = useState(() => storedToolsEquipment()?.isHaveLossChecked || false);
    const [haveLossDateOption, setHaveLossDateOption] = useState(() => storedToolsEquipment()?.haveLossDateOption || 1);
    const handleHaveLossChange = (event) => {
        setIsHaveLossChecked(event.target.checked);
    };
    const [dateOfClaim, setDateOfClaim] = useState(() => storedToolsEquipment().dateOfClaim ? new Date(storedToolsEquipment().dateOfClaim)  : new Date());
    const [lossAmount, setLossAmount] = useState(() => storedToolsEquipment()?.lossAmount || "");
    ...
    const [crossSell, setCrossSell] = useState(() => storedToolsEquipment()?.crossSell || {});
    ...
    useEffect(() => {
        ...
        sessionStorage.setItem("toolsEquipmentData", JSON.stringify(ToolsEquipmentData));
    }, [
        miscellaneousTools,
                  ...
                  colContent={[
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => setMiscellaneousTools(e.target.value)}
                  ...
                  colContent={[
                    <>
                        ...
                        <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => setRentedLeasedEquipment(e.target.value)}
                  ...
                  colContent={[
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => setScheduledEquipment(e.target.value)}
                  ...
                  colContent={[
                    <>
                       ...
                       <Select
                           ...
                           onChange={(e) => setFixedTypeOfEquipment({value: e.value, label: e.label})}
                    ...
                    {fixedTypeOfEquipment.value === 1 &&(
                        <>
                            ...
                            <Select
                              ...
                              onChange={(e) => handleFirstEquipmentInformation('equipment', {value: e.value, label: e.label})}
                  ...
                  colContent={[
                    <>
                       ...
                       <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => handleFirstEquipmentInformation('year', e.target.value)}
                  ...
                  colContent={[
                    <>
                        ...
                        <Form.Control
                            type="text"
                            placeholder="Make"
                            onChange={(e) => handleFirstEquipmentInformation('make', e.target.value)}
                  ...
                  colContent={[
                    <>
                       ...
                       <Form.Control
                            type="text"
                            placeholder="Model"
                            onChange={(e) => handleFirstEquipmentInformation('model', e.target.value)}
                  ...
                  colContent={[
                    <>
                        ...
                        <Form.Control
                            ...
                            onChange={(e) => handleFirstEquipmentInformation('serialNo', e.target.value)}
                            value={firstEquipmentInformation.serialNo}
                            disabled={!isEditing}
                        />
                    </>
                  ...
                  colContent={[
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => handleFirstEquipmentInformation('value', e.target.value)}
                  ...
                  colContent={[
                    <>
                        ...
                        <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => handleFirstEquipmentInformation('yearAcquired', e.target.value)}
                            value={firstEquipmentInformation.yearAcquired}
                            disabled={!isEditing}
                       />
                    </>
                  ]}
                  ...
                  colContent={[
                    <>
                       ...
                       <Select
                           ...
                           classNamePrefix="select"
                           options={equipmentType}
                           onChange={(e) => setTypeOfEquipment({
                            ...typeOfEquipment,
                            [index]: {value:e.value, label:e.label}
                           })}
                    ...
                    {typeOfEquipment[index]?.value === 1 &&(
                        <>
                            ...
                            <Select
                              ...
                              classNamePrefix="select"
                              options={lightMediumEquipment}
                              onChange={(e) => handleEquipmentInformationInput(index, 'equipment', {value: e.value, label: e.label})}
                              value={equipmentInformation[index]?.equipment}
                                isDisabled={!isEditing}
                             />
                        </>
                    )}
                    {typeOfEquipment[index]?.value === 2 &&(
                        <>
                        <Label labelContent="Heavy Equipment"/>
                        <Select
                           className="basic-single"
                  ...
                  colContent={[
                    <>
                       ...
                       <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => handleEquipmentInformationInput(index, 'year', e.target.value)}
                            value={equipmentInformation[index]?.year}
                            disabled={!isEditing}
                       />
                    </>
                  ]}
                  ...
                  colContent={[
                    <>
                        ...
                        <Form.Control
                            type="text"
                            placeholder="Make"
                            onChange={(e) => handleEquipmentInformationInput(index, 'make', e.target.value)}
                            value={equipmentInformation[index]?.make}
                            disabled={!isEditing}
                        />
                    </>
                  ...
                  colContent={[
                    <>
                       ...
                       <Form.Control
                            type="text"
                            placeholder="Model"
                            onChange={(e) => handleEquipmentInformationInput(index, 'model', e.target.value)}
                            value={equipmentInformation[index]?.model}
                            disabled={!isEditing}
                       />
                    </>
                  ]}
                  ...
                  colContent={[
                    <>
                        ...
                        <Form.Control
                            ...
                            onChange={(e) => handleEquipmentInformationInput(index, 'serialNo', e.target.value)}
                            value={equipmentInformation[index]?.serialNo}
                            disabled={!isEditing}
                        />
                    </>
                  ...
                  colContent={[
                    <>
                       ...
                       <NumericFormat
                           ...
                           allowNegative={false}
                           placeholder="$0.00"
                           onChange={(e) => handleEquipmentInformationInput(index, 'value', e.target.value)}
                           value={equipmentInformation[index]?.value}
                           disabled={!isEditing}
                         />
                    </>
                  ]}
                  ...
                  colContent={[
                    <>
                        ...
                        <InputMask
                            ...
                            mask="9999"
                            placeholder="Year"
                            onChange={(e) => handleEquipmentInformationInput(index, 'yearAcquired', e.target.value)}
                            value={equipmentInformation[index]?.yearAcquired}
                            disabled={!isEditing}
                       />
                    </>
                  ]}
                  ...
                  colContent={[
                    <>
                        ...
                        <Select
                             ...
                             onChange={(e) => setDeductibleAmount({value: e.value, label: e.label})}
                                isDisabled={!isEditing}
                       />
                    </>
                  ]}
