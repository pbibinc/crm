...
const ExcavationNocForm = ({ setClassCodeFormData, disabled }) => {
    const [checked, setChecked] = useState(false);
    const questionare =
        "Do you perfrom work for Public street, road, highway, dams, landfills?";
...
export default ExcavationNocForm;
