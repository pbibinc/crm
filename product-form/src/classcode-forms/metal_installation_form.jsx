...
const MetalInstallationForm = ({ setClassCodeFormData, disabled }) => {
    const [checked, setChecked] = useState(false);
    const questionare = "Do you instal security bars on doors or windows?";
...
export default MetalInstallationForm;
