                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="formAccountability">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="user_name" id="user_name" required placeholder="Type user" autocomplete="off"/>
                            </div>
        
                            <div class="mb-3 d-flex justify-content-between">
                                <h4 class="card-title">Item 1</h4>
                                <button type="button" class="add_record_btn btn btn-success waves-effect waves-light">Add Record +</button>
                            </div>
                            
                            <div class="mb-3">
                                <label>SN:</label>
                                <div>
                                    <input type="text" class="form-control" name="sn1" id="sn1" required placeholder="Serial No." autocomplete="off"/>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label>Description:</label>
                                <div>
                                    <textarea class="form-control" rows="5" name="description1" id="description1" placeholder="E.g: Jabra Biz 2300" required></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label>Qty:</label>
                                <div>
                                    <input type="text" class="form-control" name="qty1" id="qty1" required placeholder="1-99" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label>Unit Price:</label>
                                <div>
                                    <input type="text" class="form-control" name="unit_price1" id="unit_price1" required placeholder="₱ 999" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label>Amount:</label>
                                <div>
                                    <input type="text" class="form-control" name="amount1" id="amount1" required placeholder="₱ 999" autocomplete="off"/>
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                <div>
                                    <button type="submit" name="generate_record_btn" class="btn btn-primary waves-effect waves-light me-1">Generate Record</button>
