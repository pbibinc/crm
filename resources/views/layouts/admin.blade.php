@@include("partials/main.blade.php")
...
@@include("partials/body.blade.php")

<!-- Begin page -->
<div id="layout-wrapper">

    @@include("partials/menu.blade.php")
...
@@include("partials/right-sidebar.blade.php")

@@include("partials/vendor-scripts.blade.php")
