...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="container">
                ...
                <div class="col-12">
                    <div class="datetime">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <!-- Small modal -->
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#auxHistoryModal">Open History</button>
            ...
            <div class="modal fade bs-example-modal-xl" id="auxHistoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                ...
                <form class="form-control" id="timeInForm">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="button" class="btn btn-secondary custom-btn w-100" name="time_out" id="time_out" data-attribute="2" value="Time Out" {{ $result ? '' : 'disabled' }} />
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Attendance Records for <b>{{ $currentMonth }}</b>
                                <i class="ri ri-information-fill" style="font-size: 1.5em;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Here is the reference of your attendance records for the month of May. Note: Every month the record will be archived."></i>
                            </h2>
                                ...
                                <table class="table mb-0" id="attendanceDatas">
                                    <thead class="font-bold">
                                        <tr>
                                            ...
                                            <th>Type 
                                                <i class="ri ri-information-fill" style="font-size: 1.5em;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Note: If you click the 'Time out' button it will set to 'Log Out' status. Same goes to 'OT Out', 'Break In'."></i>
                                            </th>
                                            <th>Log In Time</th>
                                            <th>Log Out Time</th>
                                        </tr>
...
<script type="text/javascript">
        ...
        if (!auxTimerRunning) {
            ...
            auxTimerInterval = setInterval(() => {
                ...
                if (saveDataFlag) { // Check if the data should be saved
                    localStorage.setItem("auxDuration", JSON.stringify({ duration: seconds })); // Save the updated duration in localStorage
                }
    ...
    function resetAuxDuration() {
        ...
        if (hour >= 22 || hour < 8) {
            ...
            localStorage.setItem("auxDuration", JSON.stringify({ duration: 0 }));
        }
    }
