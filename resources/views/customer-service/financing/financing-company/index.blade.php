                ...
                <div class="row">
                    <div class="card"
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-4">List of Financing Company</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataModal').on('submit', function(e) {
                ...
                if (action == 'add') {
                    $.ajax({
                        url: "{{ route('financing-company.store') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            name: name,
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                position: 'center',
                                icon: 'success',
                                title: 'Financing Company Saved Successfully',
                    ...
                    $.ajax({
                        url: "/customer-service/financing/financing-company/" + id,
                        method: "PUT",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            name: name,
            ...
            $(document).on('click', '.btnEdit', function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "/customer-service/financing/financing-company/" + id + "/edit",
                    dataType: "json",
