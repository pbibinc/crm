<h6>Workers Compensation Quoation Form<i class="ri-information-fill" style="vertical-align: middle; color: #6c757d;"></i>
</h6>
<div class="card ">
    <div class="card-body">
                ...
                <div class="row d-flex text-center">
                      <div class="col-12">
                        ...
                        <!-- Send Quotation Email Button -->
                                 ...
                                 <!-- Save Button -->
                                 <button type="button" class="btn btn-lg btn-success editWorkersCompFormButton" data-toggle="tooltip" title="Save Form">
