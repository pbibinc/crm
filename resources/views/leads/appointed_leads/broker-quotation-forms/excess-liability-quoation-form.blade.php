<h6>Excess Liabilities Quoation Form<i class="ri-information-fill" style="vertical-align: middle; color: #6c757d;"></i>
</h6>
<div class="card ">
    <div class="card-body">
        ...
        function doSomethingWithQuoteComparison() {
                    ...
                    <div class="row d-flex text-center">
                      <div class="col-12">
                        ...
                        <!-- Send Quotation Email Button -->
                                 ...
                                 <!-- Save Button -->
                                 <button type="button" class="btn btn-lg btn-success editExcessLiabilityFormButton" data-toggle="tooltip" title="Save Form">
           ...
           `;
                    ...
                    if (lastRow.length == 0 || lastRow.children().length == 2) {
                        ...
                        $('#ExcessLiabilityContainer').append('<div class="row">' + cardContent +
                            '</div>');
                    } else {
