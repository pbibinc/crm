        ...
        function doSomethingWithQuoteComparison() {
                ...
                <div class="row d-flex text-center">
                      <div class="col-12">
                        ...
                        <!-- Send Quotation Email Button -->
                                 ...
                                 <!-- Save Button -->
                                 <button type="button" class="btn btn-lg btn-success editToolsEquipmentFormButton" data-toggle="tooltip" title="Save Form">
           ...
           `;
                    ...
                    if (lastRow.length == 0 || lastRow.children().length == 2) {
                        ...
                        $('#ToolsEquipmentContainer').append('<div class="row">' + cardContent +
                            '</div>');
                    } else {
