    ...
    <div class="col-6">
        <div class="row">
            <div class="col-10 title-card">
                ...
                <h4 class="card-title mb-0" style="color: #ffffff">Class Codes</h4> <!-- mb-0 removes default margin at the bottom -->
            </div>
        </div>
        <div class="row mb-4">
    ...
    <div class="col-6">
        <div class="row">
            <div class="col-10 title-card">
                ...
                <h4 class="card-title mb-0" style="color: #ffffff">Multiple State Work</h4> <!-- mb-0 removes default margin at the bottom -->
            </div>
        </div>
    ...
    <div class="col-6">
        <div class="row">
            <div class="col-10 title-card">
                ...
                <h4 class="card-title mb-0" style="color: #ffffff">Business Description</h4> <!-- mb-0 removes default margin at the bottom -->
            </div>
        </div>
        <div class="row">
    ...
    <div class="col-6">
        <div class="row">
            <div class="col-10 title-card">
                ...
                <h4 class="card-title mb-0" style="color: #ffffff">Recreational Facilities</h4> <!-- mb-0 removes default margin at the bottom -->
            </div>
        </div>
        <div class="row">
...
<div class="row">
    <div class="col-5 title-card">
        ...
        <h4 class="card-title mb-0" style="color: #ffffff">General Liabilities Information</h4> <!-- mb-0 removes default margin at the bottom -->
    </div>
...
<div class="row">
    <div class="col-5 title-card">
        ...
        <h4 class="card-title mb-0" style="color: #ffffff">Subcontract Information</h4> <!-- mb-0 removes default margin at the bottom -->
    </div>
</div>
<div class="row mb-3">
    <div class="col-6">
...
<div class="row">
    <div class="col-5 title-card">
        ...
        <h4 class="card-title mb-0" style="color: #ffffff">Previous General Liabilities</h4> <!-- mb-0 removes default margin at the bottom -->
    </div>
</div>
<div class="row mb-4">
    <div class="col-6">
...
<div class="row">
    <div class="col-5 title-card">
        ...
        <h4 class="card-title mb-0" style="color: #ffffff">Coverage Limit</h4> <!-- mb-0 removes default margin at the bottom -->
    </div>
</div>
<div class="row mb-3">
    <div class="col-6">
