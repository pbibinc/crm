...
<div class="row-title">
    ...
    <div>
        ...
        @elseif($builderRiskProduct->status == 1)
            <button type="button" class="sendOutBuildersRiskQuotation btn btn-success btn-sm waves-effect waves-light"
                value="{{ $builderRiskProduct->id }}">
...
<script>
    $(document).ready(function() {
        ...
        $('.sendOutBuildersRiskQuotation').on('click', function(e) {
            var id = $(this).val();
            Swal.fire({
                title: 'Are you sure?',
