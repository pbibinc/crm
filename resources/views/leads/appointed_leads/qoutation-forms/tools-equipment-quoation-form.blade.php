<div class="col-6 title-card">
    <h4 class="card-title mb-0" style="color: #ffffff">Tools Equipment Quoation Form</h4>
</div>
<div class="col-6">
        ...
        <div class="card-body">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-6">
                    ...
                    <input class="form-control brokerFee mt-2" id="brokerFee" type="text">
                </div>
            </div>
            <hr>
            ...
            <div class="card border border-primary">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <button class="btn btn-success rounded-circle addToolsEquipmentPriceComparison" id="addPriceComparisonButton"><i class="mdi mdi-plus-circle"></i></button>
