...
<script>
    $(document).ready(function (){
      ...
      function  doSomethingWithQuoteComparison() {
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        <div class="col-6">
                            ...
                            <input class="form-control mt-2 monthlyPayment" id="monthlyPayment" type="text" value="${data.monthly_payment}">
                        </div>
                        <div class="col-6">
                            <label for="filterBy" class="form-label mt-2">Broker Fee:</label>
                            <input class="form-control mt-2 brokerFee" id="brokerFee" type="text" value="${data.broker_fee}">
                        </div>
                    </div>
                    <hr>
            ...
            <div class="card border border-primary">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        <div class="col-6">
                            <label for="filterBy" class="form-label">Montly Payment:</label>
                            <input class="form-control monthlyPayment" id="monthlyPayment" type="text">
                        </div>
                        <div class="col-6">
                            <label for="filterBy" class="form-label">Broker Fee:</label>
                            <input class="form-control brokerFee" id="brokerFee" type="text">
        ...
        $('#BuildersRiskContainer').on('click', '.removeSavedDataButton', function(){
