...
<div class="page-content pt-6">
    <div class="container-fluid">
        <div class="row">
            <div class="col-7">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div>
                        <button type="button" id="assignQuotedLead" class="btn btn-primary btn-rounded mb-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Button to assign checked Leads to a selected user" style=" 0 4px 8px rgba(0, 0, 0, 0.05);">   <i class="ri-user-received-2-line" ></i> Assign Lead</button>
                        <button type="button" id="reassigQoutedLead" class="btn btn-light btn-rounded mb-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Button to reassign checked Leads to a selected user" style="background-color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05);"> <i class="ri-user-shared-2-line"></i> Reasign Lead</button>
                        <button type="button" id="voidQuotedLeads" class="btn btn-outline-danger btn-rounded mb-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Button To Void Leads to a user" style="background-color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05); "><i class="ri-user-unfollow-line"></i> Void Lead</button>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="card bg-info text-white-50" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05); border-radius: 10px; overflow: hidden;">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-truncate font-size-14 mb-2" style="color: white">Qouted Product</p>
                                        <h4 class="mb-2" style="color: white">{{ $quoationProduct->quotedProduct()->count() }}</h4>
                                    </div>
                                    <div class="avatar-sm">
                                        <span class="avatar-title bg-light text-primary rounded-3">
                ...
                <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05); border-radius: 10px; overflow: hidden;">
                    <div class="card-body" style="padding: 20px;">
                        <div class="row" style="margin-bottom: 20px;">
                            <div class="col-6">
                                <label for="brokerAssistantDropdown" class="form-label" style="font-weight: 600; color: #34495e;">Broker Assitant:</label>
                                <select id="brokerAssistantDropdown" class="form-select" style="border-radius: 5px; border: 1px solid #d1d9e6; padding: 8px 12px;">
                            ...
                            <div class="col-6">
                                <label for="agentDropdown" class="form-label" style="font-weight: 600; color: #34495e;">Agents:</label>
                                <select id="agentDropdown" class="form-select" style="border-radius: 5px; border: 1px solid #d1d9e6; padding: 8px 12px;">
        ...
        <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="quoterDropdownModal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row mb-4">
                            <div class="col-6">
                                <label for="brokerAssistantReassignDropdown" class="form-label" style="font-weight: 600; color: #34495e;">Broker Assitant:</label>
                                <select id="brokerAssistantReassignDropdown" class="form-select" style="border-radius: 5px; border: 1px solid #d1d9e6; padding: 8px 12px;">
                                    <option value="">Select Broker Assistant</option>
                                    @foreach ($userProfile->brokerAssistant() as $broker)
                                    <option value="{{ $broker->id }}">{{ $broker->fullAmericanName() }}</option>
                                    @endforeach
                            ...
                            <div class="col-6">
                                <label for="agentReassignDropdown" class="form-label" style="font-weight: 600; color: #34495e;">Agents:</label>
                                <select id="agentReassignDropdown" class="form-select" style="border-radius: 5px; border: 1px solid #d1d9e6; padding: 8px 12px;">
                                    <option value="">Select Agent</option>
                                    @foreach ($userProfile->userProfiles() as $userProfile)
                                    <option value="{{ $userProfile->id }}">{{ $userProfile->fullAmericanName() }}</option>
                                    @endforeach
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" id="submitQoutedReassign">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#voidQuotedLeads').on('click', function(){
            var userProfileId = $('#brokerAssistantDropdown').val() ? $('#brokerAssistantDropdown').val() : $('#agentDropdown').val();
        ...
        $('#submitQoutedReassign').on('click', function(){
         var userProfileId = $('#brokerAssistantReassignDropdown').val() ? $('#brokerAssistantReassignDropdown').val() : $('#agentReassignDropdown').val();
         var oldUserProfileId = $('#brokerAssistantDropdown').val() ? $('#brokerAssistantDropdown').val() : $('#agentDropdown').val();
         if(userProfileId)
         {
            $.ajax({
