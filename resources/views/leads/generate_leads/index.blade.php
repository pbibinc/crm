                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('leads.import') }}" method="POST" id="import-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <button id="import-button" class="btn btn-primary"><i class="ri-upload-fill"></i> Import Leads Data</button>
                                    </div>
                                    <div class="col-5">
                            ...
                            <form action="{{ route('leads.export')}}" method="get">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="date" value="2020-03" name="start_date" id="startDateInput">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label for="endDateInput" class="col-form-label">End Date</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="date" value="2020-03"  name="end_date" id="endDateInput">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <button id="dated-export-button" class="btn btn-success"> <i class="ri-download-fill"></i> Export Leads</button>
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a href="" style="font-size:15px; color: #0f9cf3; font-weight:500" data-bs-toggle="modal" data-bs-target="#addLeadsModal" id="create_record"><i class="mdi mdi-plus"></i> Add Lead</a>  
                    </div>
                    <div class="card">
                        <div class="card-body">
                                <div>
                ...
                <div class="col-4">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a href="{{ route('leads.archive') }}" style="font-size:15px; color: #0f9cf3; font-weight:500 margin-top:20px;"><i class="mdi mdi-archive-arrow-down"></i> Leads Archive</a>  
                    </div>
                      
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <form action="{{ route('dnc.lead.import') }}" method="POST" id="dnc-import-form" enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" name="dnc-file" class="form-control">
                                    <br>
                                    <div class="row">
                                        <div class="button-container">
                                            <button type="submit" class="btn btn-danger"><i class="mdi mdi-alert-plus"></i> Import DNC Leads</button>       
                                            <button class="btn btn-danger" id="addDnc"><i class="mdi mdi-phone-off"></i> Add DNC</button>                               
                                            <button class="btn btn-danger" id="deleteLeads"><i class="mdi mdi-trash-can-outline"></i>Delete Lead</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <br>
                            <div class="row">
                                <table class="table table-bordered dt-responsive nowrap" id="dncDataTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                    <tr>
                                        <th></th>
                                        <th>Company Name</th>
