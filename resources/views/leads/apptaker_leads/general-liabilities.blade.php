...
<div class="tab-pane active" id="general-liability-1" role="tabpanel">
    ...
    <div class="row mb-3">
        ...
        <div class="col-6">
            <input class="form-control input-mask text-left"  id="materialCost" onkeypress="return event.charCode >= 48 && event.charCode <= 57" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'">
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="haveLossModal" tabindex="-1" aria-labelledby="haveLossModal" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="subcontractModalForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label class="form-label">Any recreational facilities: hospitals, churches, school, playgrounds</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="square-switch">
                                  ...
                                  <label for="recreationalFacility" data-on-label="Yes" data-off-label="No"></label>
                                </div>
                            </div>
                        </div>
