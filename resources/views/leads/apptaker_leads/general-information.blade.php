        ...
        <form>
            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="stateInput" id="stateInput">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="altNumber" id="altNumber" placeholder="alternative number">
                    </div>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input class="form-control input-mask text-left"  id="subout" onkeypress="return event.charCode >= 48 && event.charCode <= 57" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'">
                </div>
                <div class="col-6">
                    <label for="" class="form-label">Owners Payroll</label>
                    <input class="form-control input-mask text-left"  id="ownersPayroll" onkeypress="return event.charCode >= 48 && event.charCode <= 57" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'">
                </div>
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    zipcode.forEach(function(item){
                        varSelectZipcode.append('<option value="'+item+'">'+item+'</option>');
                    });
